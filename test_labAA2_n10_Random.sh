# Tests the effectiveness of training just one time in labAA2

# Resets the qtable
cp qtable-ini.txt qtable.txt &&
# Trains in the map labAA2 for 10 game
python busters.py -p QLearningAgent -k 2 -l labAA2 -n 10 -g RandomGhost &&
