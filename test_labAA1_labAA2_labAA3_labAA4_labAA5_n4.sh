...
python busters.py -p QLearningAgent -k 3 -l labAA1 -n 4 &&
python busters.py -p QLearningAgent -k 3 -l labAA2 -n 4 &&
python busters.py -p QLearningAgent -k 3 -l labAA3 -n 4 &&
python busters.py -p QLearningAgent -k 3 -l labAA4 -n 4 &&
python busters.py -p QLearningAgent -k 3 -l labAA5 -n 4 &&
