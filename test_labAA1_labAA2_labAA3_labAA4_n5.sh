...
# Trains in the map labAA1, labAA2, labAA3, labAA4 for 5 game
python busters.py -p QLearningAgent -k 3 -l labAA1 -n 5 &&
python busters.py -p QLearningAgent -k 3 -l labAA2 -n 5 &&
python busters.py -p QLearningAgent -k 3 -l labAA3 -n 5 &&
python busters.py -p QLearningAgent -k 3 -l labAA4 -n 5 &&
