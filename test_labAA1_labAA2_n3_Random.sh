...
# Trains in the map labAA1, labAA2 for 3 game
python busters.py -p QLearningAgent -k 1 -l labAA1 -n 3 -g RandomGhost &&
python busters.py -p QLearningAgent -k 1 -l labAA2 -n 3 -g RandomGhost &&
