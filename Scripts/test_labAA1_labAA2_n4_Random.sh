...
# Trains in the map labAA1, labAA2 for 4 game
python busters.py -p QLearningAgent -k 1 -l labAA1 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 1 -l labAA2 -n 4 -g RandomGhost &&
