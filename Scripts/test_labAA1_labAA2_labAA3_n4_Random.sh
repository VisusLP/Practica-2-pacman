...
python busters.py -p QLearningAgent -k 2 -l labAA1 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 2 -l labAA2 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 2 -l labAA3 -n 4 -g RandomGhost &&
