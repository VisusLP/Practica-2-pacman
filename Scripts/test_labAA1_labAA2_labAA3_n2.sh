...
python busters.py -p QLearningAgent -k 2 -l labAA1 -n 2 &&
python busters.py -p QLearningAgent -k 2 -l labAA2 -n 2 &&
python busters.py -p QLearningAgent -k 2 -l labAA3 -n 2 &&
