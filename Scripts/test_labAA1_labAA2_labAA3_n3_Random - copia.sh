...
# Trains in the map labAA1, labAA2, labAA3  for 3 game
python busters.py -p QLearningAgent -k 2 -l labAA1 -n 3 -g RandomGhost &&
python busters.py -p QLearningAgent -k 2 -l labAA2 -n 3 -g RandomGhost &&
python busters.py -p QLearningAgent -k 2 -l labAA3 -n 3 -g RandomGhost &&
