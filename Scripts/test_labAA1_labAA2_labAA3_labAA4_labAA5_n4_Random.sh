...
# Trains in the map labAA1, labAA2, labAA3, labAA4 and labAA5 for 4 game
python busters.py -p QLearningAgent -k 3 -l labAA1 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 3 -l labAA2 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 3 -l labAA3 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 3 -l labAA4 -n 4 -g RandomGhost &&
python busters.py -p QLearningAgent -k 3 -l labAA5 -n 4 -g RandomGhost &&
