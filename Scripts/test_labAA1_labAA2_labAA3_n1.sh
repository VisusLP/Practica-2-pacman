...
python busters.py -p QLearningAgent -k 2 -l labAA1 -n 1 &&
python busters.py -p QLearningAgent -k 2 -l labAA2 -n 1 &&
python busters.py -p QLearningAgent -k 2 -l labAA3 -n 1 &&
